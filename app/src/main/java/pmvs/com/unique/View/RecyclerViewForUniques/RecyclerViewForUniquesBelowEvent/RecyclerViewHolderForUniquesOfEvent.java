 ...
 */
public class RecyclerViewHolderForUniquesOfEvent extends RecyclerView.ViewHolder  implements View.OnClickListener {
    ...
    public RecyclerViewHolderForUniquesOfEvent(View itemView,  List<Unique> uniqueList) {
        super(itemView);
