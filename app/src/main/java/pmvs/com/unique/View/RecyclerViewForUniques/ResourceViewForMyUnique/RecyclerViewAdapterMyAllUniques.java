 ...
 */
public class RecyclerViewAdapterMyAllUniques  extends RecyclerView.Adapter<RecyclerViewHolderMyAllUniques> {

        private List<Unique> myuniques = new ArrayList<>();


        public RecyclerViewAdapterMyAllUniques(List<Unique> uniqueList) {
        ...
        @Override
        public RecyclerViewHolderMyAllUniques onCreateViewHolder(ViewGroup viewGroup, int position) {
            LayoutInflater inflater = LayoutInflater.from(viewGroup.getContext());
            View eventItem = inflater.inflate(R.layout.my_unique_item_without_select, viewGroup, false);
            return new RecyclerViewHolderMyAllUniques(eventItem, myuniques);
        }

        //set data to the correct layout elements
        @Override
        public void onBindViewHolder(RecyclerViewHolderMyAllUniques viewHolder, int position) {
